...
class Image_DTO():
    ...
    image_dto = api.model('Image', {
        ...
        'classification': fields.Integer(attribute='classification', required=True, description='The classification of the image. (1 = plastic, 2 = cardboard, 3 = metal, 4 = other)'),
